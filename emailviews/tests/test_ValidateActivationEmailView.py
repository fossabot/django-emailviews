...
class SendEmailSimpleTestCase(TestCase, BaseEmailTestCase):
    ...
    def send_activation_email(self, form_data):
        return self.client.post(
            reverse('SendActivationEmailView'),
            data=form_data,
        )
    ...
    @max_examples
    @ft.given_form_data
    def test_activation_key_sent_via_email_can_expire_in_activation_view(self, form_data):
        """
        Workflow that will send activation key via
        email, grab it and visit ActivationView.
    ...
    @max_examples
    @ft.given_form_data
    def test_activation_key_sent_via_email_can_expire_in_activation_view_COPY(self, form_data):
        """
